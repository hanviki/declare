...
<script>
    ...
    import DcaBDocParttimejobDone from './DcaBDocParttimejobDone'
    ...
    export default {
        ...
        components: {DcaBDocParttimejobDone, AuditUserInfo},
        mounted() {
            this.search()
        },
        props: {
        ...
        methods: {
            ...
            exportCustomExcel () {
                ...
                this.$export('dcaBDocParttimejob/excel', {
